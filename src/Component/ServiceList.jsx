        ...
        <div className=" ">
          ...
          <div className="flex items-center flex-row mb-4 justify-between ">
            ...
            <div className="text-black bg-brightC text-center mt-2 max-w-[300px] p-4 rounded-2xl relative overflow-hidden">
              ...
              <article>
                Maintain the perfect balance with our Hybrid Fill. A touch-up
                for stunning lashes.
              </article>
            </div>
          </div>
          ...
          <div className="flex items-center flex-row mb-4 justify-between ">
            ...
            <div className="text-black bg-brightC text-center mt-2 max-w-[300px] p-4 rounded-2xl relative overflow-hidden">
              ...
              <article>
                Achieve glamourous allure with our Glam Fill. Elevate your
                beauty with dramatic and full lashes.
              </article>
            </div>
          </div>
          <div className="flex items-center flex-row mb-4 justify-between ">
          ...
          <div className="flex items-center flex-row mb-4 justify-between ">
            ...
            <div className="text-black bg-brightC text-center mt-2 max-w-[300px] p-4 rounded-2xl relative overflow-hidden">
              ...
              <article>
                For a clear and bubbly finish, choose our Bubble Clear Lop
                Glass.
              </article>
            </div>
          </div>
